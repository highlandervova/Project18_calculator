...
public class Calc extends javax.swing.JFrame {
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
       ...
       // нажатии не "запрограммированную"(лишнюю) клавишу дальше перейти к операциям можно только через С.
       //Как решить??
// =
        String s = jTextField1.getText();
        ...
        if (result.contains("(")){  //from jTextLabel1 ->если содержит период 
            //(извлечение и сборка числа из вида 1.(7865) в формат double
      //     int i =result.length();  // число в периоде ввиде 1.(7865)
      //  String mainC= result.substring(0,result.indexOf("(")); //высчитыаем первую часть ввиде 1.
        
     //   String c=result.substring(result.indexOf("(")+1,i-1); //высчитыаем вторую часть ввиде 7865
     //   int e=c.length();
    //    String main=mainC;
     //   while (main.length()<20){ // количество символов в double получаем число для вывода
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        //textField - событие
          ...
          int ch=(char)c;
           ...
           // jLabel1.setText(Integer.toString(ch));
      ...
      if (s.length()>0){
        ...
        switch(c){
            case '1': 
                ...
                break;
                 case '\b':// Why does pressing delete two characters (numbers) at once?
                     break; //jButton4ActionPerformed(null);
        ...
        if (ch==10) { // How does "ENTER press" take as character '='?
             // jLabel1.setText("ch");
        jButton19ActionPerformed(null);
        }
      }
